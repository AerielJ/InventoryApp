...
public class InventoryListActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_inventory_list); // Set activity's content to the nav_inventory_list layout fil
    ...
    public void onFABClicked(View view) {
        // Start Item Details activity when floating action button is clicked
